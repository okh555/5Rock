...
public class SocketTargetObject : MonoBehaviour
{
    ...
    {
        var socketInteractor = interactor as XRExclusiveSocketObjectInteractor;
    ...
    IEnumerator DisableSocketDelayed(XRExclusiveSocketObjectInteractor interactor)
    {
